...
- **조기 포착** — 크게 오르기 전의 조용한 구간을 노립니다. 4시간봉에서 **변동성 압축 +
  거래량 고갈 + 미결제약정(OI) 증가**를 보고 **매집 → 임박 → 돌파** 3단계로 분류합니다.
...
6. 필터 영역에서 방향·최소 셋업 점수·거래대금·진행 단계·정렬을 조정하고 **필터 적용**을 누릅니다.
...
현재 100개 테스트 전부 통과합니다. (EMA·RSI·MACD·ATR·Bollinger·VWAP·OBV,
Pivot·BOS·CHoCH, 스윕·FVG, stage 0/1, 흡수 60%/100%, stage 5 필터,
조기 포착 회귀, TradingView 심볼·15분봉 인계, prefix==full 리페인트 검증)
