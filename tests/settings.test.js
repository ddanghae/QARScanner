...
export function run() {
  ...
  test("scan mode change 이벤트가 점수 UI와 단계 필터를 즉시 동기화", () => {
    ...
    try {
      ...
      eq(earlyCut.hidden, false, "early 품질 컷 표시");
      eq(earlyCutValue.textContent, "40+", "실제 early 컷 표시");
